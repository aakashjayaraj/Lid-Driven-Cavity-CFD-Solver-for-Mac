/****************************************************************************
** Meta object code from reading C++ file 'SolverWorker.h'
**
...
#error "The header file 'SolverWorker.h' doesn't include <QObject>."
...
template <> constexpr inline auto SolverWorker::qt_create_metaobjectdata<qt_meta_tag_ZN12SolverWorkerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'finished'
        QtMocHelpers::SignalData<void(Field, Field, Field)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 }, { 0x80000000 | 6, 8 }, { 0x80000000 | 6, 9 },
        }}),
        // Signal 'done'
...
void SolverWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->finished((*reinterpret_cast<std::add_pointer_t<Field>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<Field>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<Field>>(_a[3]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SolverWorker::*)(int , int )>(_a, &SolverWorker::progress, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SolverWorker::*)(Field , Field , Field )>(_a, &SolverWorker::finished, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (SolverWorker::*)()>(_a, &SolverWorker::done, 2))
            return;
    }
}
...
// SIGNAL 0
void SolverWorker::progress(int _t1, int _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void SolverWorker::finished(Field _t1, Field _t2, Field _t3)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1, _t2, _t3);
}

// SIGNAL 2
void SolverWorker::done()
{
